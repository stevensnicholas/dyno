...
import styles from '../errors/500.module.css';
    ...
    <div className={styles.browser_window}>
      ...
      <div className='row'>
        <div id={styles.site_layout_example_top} className="col s12">
          <p className={styles.caption_uppercase}><h5 className={'center'}>Internal server error</h5></p>
        </div>
        <div id={styles.site_layout_example_right} className="col s12 m12 l12">
          <div className="row center">
            ...
            <p className="center white-text">Something has gone seriously wrong. Please try later.</p>
          </div>
        </div>
      </div>
    </div>
